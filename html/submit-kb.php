...
<?php
echo 'Gethostname function '. gethostname();
echo '<br/>PHP Uname function '.php_uname('n');
echo '<br/>Host by address '.gethostbyaddr($_SERVER["REMOTE_ADDR"]);
