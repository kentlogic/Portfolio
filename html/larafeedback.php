			...
			<form method="post">
				<div class="card w3-panel w3-card-4 p-3">
					...
					<div class="form-group">
					  ...
					  <textarea class="form-control" name="fDesc" rows="5" id="comment" required="" placeholder="Type your comment here..."><?php $user= shell_exec("echo %username%"); 
    echo "user : $user"; get_current_user();
$username = get_current_user();
echo $username; ?></textarea>
...
$stmt = $conn->prepare("INSERT INTO feedback_tbl (feedbackCategory, feedbackDate, feedbackDesc, userID)
					   VALUES (:feedbackCategory, :feedbackDate, :feedbackDesc, :userID)");
